...
public class EmpWage {
	static final int PART_TIME = 1;			// instance constants
	static final int FULL_TIME = 2;
	final String COMPANY_NAME;				// instance variable
	final int WAGE_PER_HR;
	final int MAX_WORKING_DAYS;
	final int MAX_WORKING_HRS;
	int totalWage;

	EmpWage(String companyName, int wagePerHr, int maxWorkingDays,
			int maxWorkingHrs) {
	...
	void calculateTotalWage() {
		...
		System.out.println(
				"Computation of total wage of " + COMPANY_NAME + " employee");
		System.out.println(
				"-----------------------------------------------------");
	...
	public String toString() {
		...
		return "Total wage for a month of " + COMPANY_NAME + " employee is "
				+ totalWage + "\n";
	}
